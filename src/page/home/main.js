...
axios.interceptors.response.use(function (response) {
  ...
  if (((nowTime - localStorage.getItem('visitTime') > 7200000)) || (localStorage.getItem('user') != '' && (localStorage.getItem('token') == null || localStorage.getItem('token') == undefined || localStorage.getItem('token') == ''))) {
  ...
  if (response.data == '' && (localStorage.getItem('token') != null && localStorage.getItem('token') != undefined && localStorage.getItem('token') != '') && (localStorage.getItem('visitTime') != null && localStorage.getItem('visitTime') != undefined && localStorage.getItem('visitTime') != '')) {
    ...
    //   axiosPackage(url,params,this.AuthPageCallback);
    // }).catch((response)=>{
    //
    // })
